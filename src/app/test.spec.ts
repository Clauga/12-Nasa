...
describe('Quest Test Suite', () => {
  ...
  fit('component should display an image', async(() => {
    const fixture = TestBed.createComponent(AppComponent);
    const service: NasaService = TestBed.get(NasaService);
    const mockImageUrl = 'https://apod.nasa.gov/apod/image/1903/IC405_Abolfath_3171.jpg';
  
    spyOn(service, 'getImageOfTheDay').and.returnValue(of(mockImageUrl));
  
    fixture.detectChanges();
    const compiled = fixture.debugElement.nativeElement;
    const imgElement = compiled.querySelector('img');
    expect(imgElement).toBeTruthy();
    expect(imgElement.src).toContain(mockImageUrl);
  }));
